...
static const char *fonts[]          = { "Fantasque Sans Mono:style=Regular:size=22:antialiasing=true", "Font Awesome 6:Style=Regular:size=22:antialiasing=true", };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_m,	   spawn,	   SHCMD("mpc play") },
	{ MODKEY|ShiftMask,		XK_l,	   spawn,	   SHCMD("mpc next") },
	{ MODKEY|ShiftMask,		XK_h,	   spawn,	   SHCMD("mpc prev") },
	{ MODKEY|ShiftMask,		XK_b,	   spawn,	   SHCMD("mpc stop") },
